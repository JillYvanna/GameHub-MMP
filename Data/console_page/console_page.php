...
<?php include "../header/header_console.php" ?>
        ...
        <section class="product-list">
            ...
            <div class="product-container">
                    <?php
                                ...
                                $query = 'SELECT Console_Name, Brand, Price_Rent, Picture FROM ConsoleData';
                                ...
                                while( $record = mysqli_fetch_assoc( $result))
                                {
                                    ...
                                    <div class="card">
                                        ...
                                        <?php
                                        echo '<div class="product-title">'.$record['Console_Name'].'</div>';
                                        ?>
                                        ...
                                        <?php
                                        echo '<div class="text">'.$record['Brand'].'</div>';
                                        ?>
                                        <div class="footer">
